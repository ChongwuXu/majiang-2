...
(function (game) {
     ...
     * author:  徐为
     */
    var C2s_RelationPacket = (function (_super) {
        __extends(C2s_RelationPacket, _super);
        /********************************/
        /********************************/
        function C2s_RelationPacket() {
            var _this = _super.call(this) || this;
            _this.m_oHead.m_nPktType = game.Protocol.s_C2S_LOGIN;
            _this.m_sActionType = game.Packet.s_Login;
            return _this;
        }
        C2s_RelationPacket.prototype.fRead = function (by) {
        ...
        C2s_RelationPacket.prototype.fWrite = function () {
        ...
        return C2s_RelationPacket;
    }(game.Packet));
    game.C2s_RelationPacket = C2s_RelationPacket;
    __reflect(C2s_RelationPacket.prototype, "game.C2s_RelationPacket");
})(game || (game = {}));
//# sourceMappingURL=C2s_RelactionPacket.js.map